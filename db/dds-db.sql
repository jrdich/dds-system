...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3162323353ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="269">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dds-db&table=user_steps">`dds-db`.`user_steps`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dds-db&table=programs">`dds-db`.`programs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dds-db&table=program_steps">`dds-db`.`program_steps`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dds-db&table=bodybuilders">`dds-db`.`bodybuilders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=team2&table=bodybuilders">`team2`.`bodybuilders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=team2&table=admin">`team2`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=team2&table=bmi_tracker">`team2`.`bmi_tracker`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3b555a72736d22514b7b3b57486e3579">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="269"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
