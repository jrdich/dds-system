    ...
    <body>
                    ...
                    <div class="col-lg-3">
                        <div class="top-option">
                            <div>
                                ...
                                <?php endif; ?>
                                <?php if (isset($_SESSION['username'])) : ?>
                                    <a href="queries/logout.php">Log out</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <section class="hero-section">
            <div class="hs-slider owl-carousel">
                <div class="hs-item set-bg" data-setbg="dist/images/bg.jpg">
                    <div class="container">
                        <div class="row">
                ...
                <div class="hs-item set-bg" data-setbg="dist/images/siginpage.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-6">
                                <div class="hi-text">
